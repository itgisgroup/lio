...
export default function App() {
  ...
  useEffect(() => { if (window.location.pathname === "/doc" || window.location.pathname === "/doc/vi") { const locale = window.location.pathname.endsWith("/vi") ? "/docs/vi" : "/docs"; window.location.replace(window.location.hostname === "localhost" ? `http://localhost:4321${locale}` : locale) } }, [])
  return <div className="site-shell"><ContactFab /><a className="docs-launch" href="/doc">Tài liệu Lio <ArrowRight size={14}/></a>
